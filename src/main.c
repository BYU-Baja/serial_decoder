...
int get_baud(int value) {
    switch (value) {
        ...
        case 460800:
            return SERIAL_460800; // NOTE: CLion is flagging this identifier through SERIAL_4000000 as undefined in serial.h
        case 500000:
...
static void parse_args(int argc, char **argv) {
    ...
    while ((opt = getopt_long(argc, argv, "b:vh::p::", long_options, NULL)) != -1) {
        switch (opt) {
            case 'v':
                verbose = true;
                break;
